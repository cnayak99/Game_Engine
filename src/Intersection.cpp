 ...
 */
extern bool hasIntersection(const SDL_Rect * player, const SDL_Rect * terrain) {
    ...
    if ((player->x >= terrain->x) && (player->x < (terrain->x + terrain->w - 1))) {
        if ((player->y >= terrain->y) && (player->y < (terrain->y + terrain->h - 1))) {
            return true;
        } else if (((player->y + player->h - 1) >= terrain->y) && ((player->y + player->h - 1) < (terrain->y + terrain->h - 1))) {
            return true;
        }
    } else if (((player->x + player->w - 1) >= terrain->x) && ((player->x + player->w - 1) < (terrain->x + terrain->w - 1))) {
        if ((player->y >= terrain->y) && (player->y < (terrain->y + terrain->h - 1))) {
            return true;
        } else if (((player->y + player->h - 1) >= terrain->y) && ((player->y + player->h - 1) < (terrain->y + terrain->h - 1))) {
            return true;
 ...
 * @author Lillie Sharpe (lssharpe)
 */
extern int intersect(const SDL_Rect * player, const SDL_Rect * terrain) {
    // Checks the four corners of the player rectangle in comparison to the bounds
    // of the terrain rectangle.
    if ((player->x >= terrain->x) && (player->x < (terrain->x + terrain->w - 1))) {
        if ((player->y >= terrain->y) && (player->y < (terrain->y + terrain->h - 1))) {
            return 1;
        } else if (((player->y + player->h - 1) >= terrain->y) && ((player->y + player->h - 1) < (terrain->y + terrain->h - 1))) {
